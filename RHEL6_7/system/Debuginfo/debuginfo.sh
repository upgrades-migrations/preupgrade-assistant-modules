...
log_slight_risk "Dependencies can cause incompleteness of the debugging tree after the upgrade, you may need to install additional debuginfos after the upgrade."
exit_fail
